...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      const url = `http://10.112.6.250:8888/api/v1/sensor?dev_id=1000004700080003&begin_time=${beginTime}&end_time=${endTime}`;
      ...
      axios({
        ...
        console.log(res, this.ch1, this.ch2)
        // 在获取到数据后绘制折线图
        this.drawChart();
      });
    },
    initChart() {
      this.chart = echarts.init(document.getElementById('TempWet'));
      this.drawChart();
    },
  },
  mounted() {
