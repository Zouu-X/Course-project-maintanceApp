...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      const url = `http://10.112.6.250:8888/api/v1/sensor?dev_id=1000004700070002&begin_time=${beginTime}&end_time=${endTime}`;
    ...
    initChart() {
      this.chart = echarts.init(document.getElementById('Temp'));
      this.drawChart();
    },
    getMaxValue() {
